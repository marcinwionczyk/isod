...
class UserController extends Controller
{
	...
	{
		return array('https','accessControl', // perform access control for CRUD operations
		);
	}
	...
	public function actionCreate()
	{
		...
		$this->render('create',array(
			'model'=>$model,'roles'=>CHtml::listData($roles, 'id', 'name'))
		);
	}
	...
	public function actionDelete($id)
	{
		if(Yii::app()->request->isPostRequest)
		{
			...
			throw new CHttpException(400,'Nieprawidłowy adres URL. Proszę nie wpisywać tego adresu ponownie.');
	}
