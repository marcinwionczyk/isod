...
class EFlowPlayer extends CWidget
{
    ...
    public function init()
    {
        ...
        if(!isset($this->swfUrl)) $this->swfUrl = $this->assets."/flowplayer-3.2.12.swf";
    }
    /** 
    ...
    private function flowplayerScript($flv = null)
    {
        ...
        Yii::app()->clientScript->registerScript($this->htmlOptions['id'], 
            "flowplayer('".$this->htmlOptions['id']."','".$this->swfUrl."', {clip:{autoPlay: false, autoBuffering: true},play:{label:null,replayLabel: 'Odtwórz ponownie'},playlist: ['".$flv."']})", 
